...
class CompleteOrthogonalDecomposition
 ...
 public:
  ...
  inline constexpr Solve<CompleteOrthogonalDecomposition, Rhs> solve(const MatrixBase<Rhs>& b) const;
#endif
   ...
   */
  inline constexpr Inverse<CompleteOrthogonalDecomposition> pseudoInverse() const {
...
template <typename MatrixType, typename PermutationIndex>
constexpr typename CompleteOrthogonalDecomposition<MatrixType, PermutationIndex>::HouseholderSequenceType
