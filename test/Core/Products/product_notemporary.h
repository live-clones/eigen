...
#ifndef EIGEN_TEST_PRODUCT_NOTEMPORARY_H
#define EIGEN_TEST_PRODUCT_NOTEMPORARY_H
...
void check_scalar_multiple2(Dst& dst, const Lhs& A, const Rhs& B, S2 s2) {
  check_scalar_multiple3(dst, A, B);
  check_scalar_multiple3(dst, A, -B);
  check_scalar_multiple3(dst, A, s2 * B);
  check_scalar_multiple3(dst, A, B * s2);
  check_scalar_multiple3(dst, A, (B * s2).conjugate());
}
...
void check_scalar_multiple1(Dst& dst, const Lhs& A, const Rhs& B, S1 s1, S2 s2) {
  check_scalar_multiple2(dst, A, B, s2);
  check_scalar_multiple2(dst, -A, B, s2);
  check_scalar_multiple2(dst, s1 * A, B, s2);
  check_scalar_multiple2(dst, A * s1, B, s2);
  check_scalar_multiple2(dst, (A * s1).conjugate(), B, s2);
}
...
#endif  // EIGEN_TEST_PRODUCT_NOTEMPORARY_H
