...
EIGEN_DECLARE_TEST(qtvector) {
  ...
  check_qtvector_matrix(Matrix3d());
  ...
  // some dynamic sizes
  check_qtvector_matrix(MatrixXd(1, 1));
  check_qtvector_matrix(VectorXd(20));
  check_qtvector_matrix(RowVectorXf(20));
  check_qtvector_matrix(MatrixXcf(10, 10));

  // some Transform
  check_qtvector_transform(Affine2f());
  check_qtvector_transform(Affine3f());
  check_qtvector_transform(Affine3d());
  // check_qtvector_transform(Transform4d());

  // some Quaternion
  check_qtvector_quaternion(Quaternionf());
  check_qtvector_quaternion(Quaternionf());
}
