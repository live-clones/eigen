...
#ifndef EIGEN_TEST_VISITOR_HELPERS_H
#define EIGEN_TEST_VISITOR_HELPERS_H
...
void visitor_vec_boundary() {
  ...
  for (int si = 0; si < 11; ++si) {
    ...
    if (n >= 2) {
      ...
      // Test as n x 1 and 1 x n (different inner sizes for visitor traversal).
      Mat mc = v;
      Mat mr = v.transpose();
      Index ri, ci;
...
#endif  // EIGEN_TEST_VISITOR_HELPERS_H
