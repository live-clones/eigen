...
class TriangularBase : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr auto operator+(const TriangularBase<OtherDerived>& other) const {
  ...
  EIGEN_DEVICE_FUNC constexpr const ConjugateReturnType conjugate() const {
   ...
   */
  template <bool Cond>
  EIGEN_DEVICE_FUNC constexpr std::conditional_t<Cond, ConjugateReturnType, ConstView> conjugateIf() const {
