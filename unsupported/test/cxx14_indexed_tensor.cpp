...
EIGEN_DECLARE_TEST(test_cxx14_indexed_tensor)
{
  ...
  CALL_SUBTEST_6(test_tensor_product<ColMajor>());
  CALL_SUBTEST_6(test_tensor_product<RowMajor>());
  CALL_SUBTEST_7(test_contraction<ColMajor>());
  CALL_SUBTEST_7(test_contraction<RowMajor>());
  CALL_SUBTEST_8(test_addition<ColMajor>());
  CALL_SUBTEST_8(test_addition<RowMajor>());
  CALL_SUBTEST_9(test_substraction<ColMajor>());
  CALL_SUBTEST_9(test_substraction<RowMajor>());
