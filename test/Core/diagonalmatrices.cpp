...
TEST(DiagonalMatricesTest, Bug2013) { bug2013<0>(); }
...
TEST(DiagonalMatricesTest, SelfadjointDiagonalProducts) { selfadjoint_diagonal_products<0>(); }
...
TEST(DiagonalMatricesTest, SelfadjointDiagonalProductsBlockPath) { selfadjoint_diagonal_products_block_path<0>(); }
...
TEST(DiagonalMatricesTest, StructuredDiagonalAliasing) { structured_diagonal_aliasing<0>(); }
