...
struct binary_evaluator<CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs>, IteratorBased, IteratorBased>
  : sparse_conjunction_evaluator<CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs> >
{
  typedef CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs> XprType;
  typedef sparse_conjunction_evaluator<XprType> Base;
  explicit binary_evaluator(const XprType& xpr) : Base(xpr) {}
};
// "dense && sparse"
template<typename Lhs, typename Rhs>
struct binary_evaluator<CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs>, IndexBased, IteratorBased>
  : sparse_conjunction_evaluator<CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs> >
{
  typedef CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs> XprType;
  typedef sparse_conjunction_evaluator<XprType> Base;
...
// "sparse && dense"
template<typename Lhs, typename Rhs>
struct binary_evaluator<CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs>, IteratorBased, IndexBased>
  : sparse_conjunction_evaluator<CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs> >
{
  typedef CwiseBinaryOp<scalar_boolean_and_op<Scalar>, Lhs, Rhs> XprType;
  typedef sparse_conjunction_evaluator<XprType> Base;
