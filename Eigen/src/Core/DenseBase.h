...
#endif // not EIGEN_PARSED_BY_DOXYGEN
{
  public:
    ...
    */
    ...
    CwiseTernaryOp<internal::scalar_select_op<Scalar, typename DenseBase<ThenDerived>::Scalar, typename DenseBase<ElseDerived>::Scalar>, Derived, ThenDerived, ElseDerived>
    select(const DenseBase<ThenDerived>& thenMatrix, const DenseBase<ElseDerived>& elseMatrix) const;
    
    template<typename ThenDerived>
    CwiseTernaryOp<internal::scalar_select_op<Scalar, typename DenseBase<ThenDerived>::Scalar, typename DenseBase<ThenDerived>::Scalar>, Derived, ThenDerived, typename DenseBase<ThenDerived>::ConstantReturnType>
    select(const DenseBase<ThenDerived>& thenMatrix, const typename DenseBase<ThenDerived>::Scalar& elseScalar) const;

    template<typename ElseDerived>
    CwiseTernaryOp<internal::scalar_select_op<Scalar, typename DenseBase<ElseDerived>::Scalar, typename DenseBase<ElseDerived>::Scalar>, Derived, typename DenseBase<ElseDerived>::ConstantReturnType, ElseDerived>
