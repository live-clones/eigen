...
class UniformScaling {
 ...
 public:
  ...
  // TODO: Return an expression template instead of dense matrix for better performance.
  // Currently materializes the product into a new matrix due to scalar multiplication of matrix.
