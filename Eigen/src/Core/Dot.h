...
struct squared_norm_impl {
  ...
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Real run(const Derived& a) {
...
struct squared_norm_impl<Derived, bool> {
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr bool run(const Derived& a) { return a.any(); }
};
