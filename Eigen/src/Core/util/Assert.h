...
struct assert_handler_impl {
  EIGEN_DEVICE_FUNC static constexpr void run(const char* expression, const char* file, unsigned line,
                                              const char* function) {
...
EIGEN_DEVICE_FUNC constexpr void __assert_handler(const char* expression, const char* file, unsigned line,
                                                  const char* function) {
