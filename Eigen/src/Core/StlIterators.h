...
class indexed_based_stl_iterator_base {
 ...
 public:
  ...
  constexpr indexed_based_stl_iterator_base() noexcept : mp_xpr(0), m_index(0) {}
...
class pointer_based_stl_iterator {
 ...
 public:
  ...
  constexpr pointer_based_stl_iterator() noexcept : m_ptr(0) {}
  constexpr pointer_based_stl_iterator(XprType& xpr, Index index) noexcept : m_incr(xpr.innerStride()) {
