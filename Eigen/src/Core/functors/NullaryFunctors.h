...
struct scalar_constant_op {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()() const { return m_other; }
  template <typename PacketType>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr PacketType packetOp() const {
...
struct scalar_zero_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr scalar_zero_op() = default;
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()() const { return Scalar(0); }
  template <typename PacketType>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr PacketType packetOp() const {
...
struct scalar_identity_op {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(IndexType row, IndexType col) const {
...
struct linspaced_op_impl<Scalar, /*IsInteger*/ false> {
  ...
  template <typename IndexType>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(IndexType i) const {
    if (m_flip)
