...
class DiagonalPreconditioner {
 ...
 public:
  ...
  constexpr Solve<DiagonalPreconditioner, Rhs> solve(const MatrixBase<Rhs>& b) const {
  ...
  constexpr ComputationInfo info() const { return Success; }
...
class IdentityPreconditioner {
 public:
  ...
  template <typename Rhs>
  constexpr const Rhs& solve(const Rhs& b) const {
    return b;
  }
