...
class NestByValue : public internal::dense_xpr_base<NestByValue<ExpressionType> >::type {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr std::enable_if<HasDirectAccess, const Scalar*>::type data() const {
    return m_expression.data();
  }

  EIGEN_DEVICE_FUNC constexpr std::enable_if<HasDirectAccess, Index>::type innerStride() const {
    return m_expression.innerStride();
  }

  EIGEN_DEVICE_FUNC constexpr std::enable_if<HasDirectAccess, Index>::type outerStride() const {
