...
// Shared header for split realview tests.

#ifndef EIGEN_TEST_REALVIEW_HELPERS_H
#define EIGEN_TEST_REALVIEW_HELPERS_H
...
namespace internal {
template <>
struct random_impl<TestComplex> : random_impl<std::complex<float>> {};
}  // namespace internal
}  // namespace Eigen
...
#endif  // EIGEN_TEST_REALVIEW_HELPERS_H
