...
EIGEN_DECLARE_TEST(vectorization_logic) {
  ...
  vectorization_logic_half<int>::run();
  vectorization_logic_half<float>::run();
  vectorization_logic_half<double>::run();
  vectorization_logic_half<std::complex<float> >::run();
  vectorization_logic_half<std::complex<double> >::run();
