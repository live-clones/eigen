...
class LLT {
 ...
 private:
  ...
  DeviceMatrix<Scalar> solve_impl(int64_t nrhs, int64_t ldb, CopyRhs&& copy_rhs) const {
    ...
    EIGEN_CUSOLVER_CHECK(cusolverDnXpotrs(ctx_.cusolver_, ctx_.params_.p, uplo, n_, nrhs, dtype,
  ...
  void factorize() {
    ...
    EIGEN_CUSOLVER_CHECK(cusolverDnXpotrf_bufferSize(ctx_.cusolver_, ctx_.params_.p, uplo, n_,
    ...
    EIGEN_CUSOLVER_CHECK(cusolverDnXpotrf(ctx_.cusolver_, ctx_.params_.p, uplo, n_, dtype,
