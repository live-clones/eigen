...
class LDLT : public SolverBase<LDLT<MatrixType_, UpLo_> > {
 public:
   ...
   */
  constexpr LDLT() : m_matrix(), m_transpositions(), m_sign(internal::ZeroSign), m_isInitialized(false) {}
   ...
   */
  inline constexpr const TranspositionType& transpositionsP() const {
    eigen_assert(m_isInitialized && "LDLT is not initialized.");
    return m_transpositions;
  }

  /** \returns the coefficients of the diagonal matrix D */
  inline constexpr Diagonal<const MatrixType> vectorD() const {
    eigen_assert(m_isInitialized && "LDLT is not initialized.");
  ...
  inline constexpr bool isNegative(void) const {
    eigen_assert(m_isInitialized && "LDLT is not initialized.");
  ...
  inline constexpr const Solve<LDLT, Rhs> solve(const MatrixBase<Rhs>& b) const;
#endif
   ...
   */
  inline constexpr const MatrixType& matrixLDLT() const {
    eigen_assert(m_isInitialized && "LDLT is not initialized.");
    return m_matrix;
  }
...
inline constexpr const LDLT<typename SelfAdjointView<MatrixType, UpLo>::PlainObject, UpLo>
 ...
 */
template <typename Derived>
inline constexpr const LDLT<typename MatrixBase<Derived>::PlainObject> MatrixBase<Derived>::ldlt() const {
