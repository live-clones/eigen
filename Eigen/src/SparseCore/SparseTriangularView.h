 ...
 public:
  ...
  class InnerIterator : public EvalIterator {
   ...
   public:
    ...
    constexpr Index row() const { return (ArgType::Flags & RowMajorBit ? Base::outer() : this->index()); }
    constexpr Index col() const { return (ArgType::Flags & RowMajorBit ? this->index() : Base::outer()); }
...
template <int Mode>
constexpr const TriangularView<const Derived, Mode> SparseMatrixBase<Derived>::triangularView() const {
