...
struct hseq_side_dependent_impl {
  ...
  static EIGEN_DEVICE_FUNC inline constexpr const EssentialVectorType essentialVector(const HouseholderSequenceType& h,
                                                                                      Index k) {
...
struct hseq_side_dependent_impl<VectorsType, CoeffsType, OnTheRight> {
  ...
  static inline constexpr const EssentialVectorType essentialVector(const HouseholderSequenceType& h, Index k) {
    Index start = k + 1 + h.m_shift;
...
class HouseholderSequence : public EigenBase<HouseholderSequence<VectorsType, CoeffsType, Side> > {
 ...
 public:
   ...
   */
  template <bool Cond>
  EIGEN_DEVICE_FUNC inline constexpr std::conditional_t<Cond, ConjugateReturnType, ConstHouseholderSequence>
  conjugateIf() const {
  ...
  inline constexpr void applyThisOnTheRight(Dest& dst) const {
  ...
  /** \internal */
  template <typename Dest, typename Workspace>
  inline constexpr void applyThisOnTheRight(Dest& dst, Workspace& workspace) const {
  ...
  /** \internal */
  template <typename Dest>
  inline constexpr void applyThisOnTheLeft(Dest& dst, bool inputIsIdentity = false) const {
  ...
  /** \internal */
  template <typename Dest, typename Workspace>
  inline constexpr void applyThisOnTheLeft(Dest& dst, Workspace& workspace, bool inputIsIdentity = false) const {
