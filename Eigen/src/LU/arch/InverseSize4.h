...
struct compute_inverse_size4<Architecture::Target, float, MatrixType, ResultType> {
  ...
  static void run(const MatrixType &mat, ResultType &result) {
    ...
    EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet4f)) const float sign_mask[4] = {0.0f, neg_zero, neg_zero, 0.0f};
...
struct compute_inverse_size4<Architecture::Target, double, MatrixType, ResultType> {
  ...
  static void run(const MatrixType &mat, ResultType &result) {
    ...
    EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2d)) const double sign_mask1[2] = {0.0, neg_zero};
    EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2d)) const double sign_mask2[2] = {neg_zero, 0.0};
