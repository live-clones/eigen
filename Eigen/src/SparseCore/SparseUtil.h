...
constexpr int CoherentAccessPattern = 0x1;
constexpr int InnerRandomAccessPattern = 0x2 | CoherentAccessPattern;
constexpr int OuterRandomAccessPattern = 0x4 | CoherentAccessPattern;
constexpr int RandomAccessPattern = 0x8 | OuterRandomAccessPattern | InnerRandomAccessPattern;
...
struct SparseTriangularShape {
  static constexpr std::string_view debugName() { return "SparseTriangularShape"; }
};
struct SparseSelfAdjointShape {
  static constexpr std::string_view debugName() { return "SparseSelfAdjointShape"; }
};
