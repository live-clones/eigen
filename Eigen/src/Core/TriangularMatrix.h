...
class TriangularBase : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr Scalar coeff(Index row, Index col) const { return derived().coeff(row, col); }
  EIGEN_DEVICE_FUNC constexpr Scalar& coeffRef(Index row, Index col) { return derived().coeffRef(row, col); }
...
class TriangularView
 ...
 public:
   ...
   */
  template <bool Cond>
  EIGEN_DEVICE_FUNC constexpr std::conditional_t<Cond, ConjugateReturnType, ConstTriangularView> conjugateIf() const {
  ...
  EIGEN_DEVICE_FUNC constexpr const AdjointReturnType adjoint() const { return AdjointReturnType(m_matrix.adjoint()); }
...
class TriangularViewImpl<MatrixType_, Mode_, Dense> : public TriangularBase<TriangularView<MatrixType_, Mode_>> {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr Index outerStride() const { return derived().nestedExpression().outerStride(); }
  /** \returns the inner-stride of the underlying dense matrix
   * \sa DenseCoeffsBase::innerStride() */
  EIGEN_DEVICE_FUNC constexpr Index innerStride() const { return derived().nestedExpression().innerStride(); }
