...
class SparseSelfAdjointView : public EigenBase<SparseSelfAdjointView<MatrixType, Mode_> > {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr SparseSelfAdjointView(const SparseSelfAdjointView&) = default;
...
constexpr void sparse_selfadjoint_time_dense_product(const SparseLhsType& lhs, const DenseRhsType& rhs,
