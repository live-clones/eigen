...
class SkewSymmetricBase : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr const SkewSymmetricVectorType& vector() const { return derived().vector(); }
  /** \returns a const reference to the derived object's vector of coefficients. */
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricVectorType& vector() { return derived().vector(); }
  ...
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricScaleReturnType operator*(const Scalar& scalar) const {
  ...
  EIGEN_DEVICE_FUNC friend constexpr ScaleSkewSymmetricReturnType operator*(const Scalar& scalar,
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricSumReturnType<OtherDerived> operator+(
      const SkewSymmetricBase<OtherDerived>& other) const {
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricDifferenceReturnType<OtherDerived> operator-(
      const SkewSymmetricBase<OtherDerived>& other) const {
    return (vector() - other.vector()).asSkewSymmetric();
  }
};
...
class SkewSymmetricMatrix3 : public SkewSymmetricBase<SkewSymmetricMatrix3<Scalar_>> {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricVectorType& vector() { return m_vector; }

  /** Default constructor without initialization */
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricMatrix3() = default;

  /** Constructor from three scalars */
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricMatrix3(const Scalar& x, const Scalar& y, const Scalar& z)
      : m_vector(x, y, z) {}

  /** \brief Constructs a SkewSymmetricMatrix3 from an r-value vector type */
  EIGEN_DEVICE_FUNC explicit constexpr SkewSymmetricMatrix3(SkewSymmetricVectorType&& vec) : m_vector(std::move(vec)) {}

  /** generic constructor from expression of the coefficients */
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC explicit constexpr SkewSymmetricMatrix3(const MatrixBase<OtherDerived>& other) : m_vector(other) {}

  /** Copy constructor. */
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC constexpr SkewSymmetricMatrix3(const SkewSymmetricBase<OtherDerived>& other)
      : m_vector(other.vector()) {}

#ifndef EIGEN_PARSED_BY_DOXYGEN
  /** copy constructor. prevent a default copy constructor from hiding the other templated constructor */
  constexpr SkewSymmetricMatrix3(const SkewSymmetricMatrix3& other) : m_vector(other.vector()) {}
#endif
  ...
  EIGEN_DEVICE_FUNC constexpr void setZero() { m_vector.setZero(); }
};
...
class SkewSymmetricWrapper : public SkewSymmetricBase<SkewSymmetricWrapper<SkewSymmetricVectorType_>>,
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC explicit constexpr SkewSymmetricWrapper(SkewSymmetricVectorType& a_vector) : m_vector(a_vector) {}
...
EIGEN_DEVICE_FUNC constexpr const Product<Derived, SkewDerived, LazyProduct> MatrixBase<Derived>::operator*(
