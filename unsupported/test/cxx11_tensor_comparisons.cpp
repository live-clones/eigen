...
static void test_orderings()
{
  ...
  Tensor<cmp_type, 3> lt(2,3,7);
  Tensor<cmp_type, 3> le(2,3,7);
  Tensor<cmp_type, 3> gt(2,3,7);
  Tensor<cmp_type, 3> ge(2,3,7);
...
static void test_equality()
{
  ...
  Tensor<cmp_type, 3> eq(2,3,7);
  Tensor<cmp_type, 3> ne(2,3,7);
  eq = (mat1 == mat2);
  ne = (mat1 != mat2);
