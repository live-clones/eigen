...
constexpr int matrix_log_get_pade_degree(float normTminusI) {
...
constexpr int matrix_log_get_pade_degree(double normTminusI) {
...
constexpr int matrix_log_get_pade_degree(long double normTminusI) {
