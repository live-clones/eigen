...
// Define a macro to enable indexed tensors if supported
#ifndef EIGEN_CXX11_TENSOR_HAS_INDEXED_TENSOR
#if EIGEN_HAS_CXX14_RETURN_TYPE_DEDUCTION && EIGEN_HAS_CXX14_LIB_INTEGER_SEQUENCE
#define EIGEN_CXX11_TENSOR_HAS_INDEXED_TENSOR 1
#else
#define EIGEN_CXX11_TENSOR_HAS_INDEXED_TENSOR 0
#endif
#endif
