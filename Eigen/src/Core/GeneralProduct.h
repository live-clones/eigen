...
// value even in an SME build. The SME kernels have their own, larger crossover
// -- see EIGEN_SME_GEMM_TO_COEFFBASED_THRESHOLD in products/GeneralMatrixMatrix.h
// and EIGEN_SME_FIXED_SIZE_GEMM_TO_COEFFBASED_THRESHOLD below.
