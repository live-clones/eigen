...
class NoAlias {
 public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr explicit NoAlias(ExpressionType& expression) : m_expression(expression) {}

  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE ExpressionType& operator=(const StorageBase<OtherDerived>& other) {
  ...
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr ExpressionType& expression() const { return m_expression; }
...
NoAlias<Derived, MatrixBase> EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE MatrixBase<Derived>::noalias() {
