...
class gebp_traits<std::complex<RealScalar>, RealScalar, ConjLhs_, false, Arch, PacketSize_> {
 public:
  ...
  EIGEN_STRONG_INLINE void loadRhsQuad_impl(const RhsScalar* b, RhsPacket& dest, const true_type&) const {
    // TODO: Optimize this pattern: currently duplicates RHS values into temp array before loading.
    //       Consider implementing a direct load operation if the target architecture supports it.
