...
class QuaternionBase : public RotationBase<Derived, 3> {
 public:
  ...
  /** \returns a vector containing the coefficients in the order [\c w, \c x, \c y, \c z],
   *
  ...
  /** \returns a vector containing the coefficients in the order [\c x, \c y, \c z, \c w],
   *
...
/** Constructs a quaternion from its coefficients in the order [\c x, \c y, \c
 * z, \c w], i.e. vector part [\c x, \c y, \c z] first, scalar part \a w LAST
 *
 * This factory accepts the parameters in the same order as the underlying
 * coefficient vector Consider using this factory function to make the
...
/** Constructs a quaternion from its coefficients in the order [\c w, \c x, \c
 * y, \c z], i.e. scalar part \a w FIRST, vector part [\c x, \c y, \c z] last
 *
 t
 * constructor \code Quaternion(const Scalar& w, const Scalar& x, const Scalar&
 * y, const Scalar& z) \endcode, Consider using this factory function to make
 * the parameter ordering explr
 */
template <typename Scalar, int Options>
