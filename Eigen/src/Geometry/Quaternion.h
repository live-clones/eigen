...
class QuaternionBase : public RotationBase<Derived, 3> {
 public:
  ...
  template <typename NewScalarType>
  EIGEN_DEVICE_FUNC constexpr std::enable_if_t<internal::is_same<Scalar, NewScalarType>::value, const Derived&> cast()
      const {
    return derived();
  }

  template <typename NewScalarType>
  EIGEN_DEVICE_FUNC constexpr std::enable_if_t<!internal::is_same<Scalar, NewScalarType>::value,
