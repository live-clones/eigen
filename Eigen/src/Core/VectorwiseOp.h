...
template <typename ExpressionType, int Direction,
          bool ComplexInnerReduction = NumTraits<typename ExpressionType::Scalar>::IsComplex &&
...
// Complex inner reductions reuse squaredNorm()'s realView() and runtime-contiguity paths.
// Outer reductions retain packet evaluation across adjacent rows or columns.
template <typename ExpressionType, int Direction>
