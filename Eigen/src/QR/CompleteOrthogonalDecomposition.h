...
class CompleteOrthogonalDecomposition
 ...
 public:
  ...
  constexpr Solve<CompleteOrthogonalDecomposition, Rhs> solve(const MatrixBase<Rhs>& b) const;
#endif
   ...
   */
  constexpr Inverse<CompleteOrthogonalDecomposition> pseudoInverse() const {
