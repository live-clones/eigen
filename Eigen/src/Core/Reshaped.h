...
class Reshaped : public ReshapedImpl<XprType, Rows, Cols, Order, typename internal::traits<XprType>::StorageKind> {
 ...
 public:
   ...
   */
  EIGEN_DEVICE_FUNC inline constexpr Reshaped(XprType& xpr) : Impl(xpr) {
   ...
   */
  EIGEN_DEVICE_FUNC inline constexpr Reshaped(XprType& xpr, Index reshapeRows, Index reshapeCols)
...
class ReshapedImpl<XprType, Rows, Cols, Order, Dense>
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC inline constexpr ReshapedImpl(XprType& xpr) : Impl(xpr) {}
  EIGEN_DEVICE_FUNC inline constexpr ReshapedImpl(XprType& xpr, Index reshapeRows, Index reshapeCols)
      : Impl(xpr, reshapeRows, reshapeCols) {}
};
...
class ReshapedImpl_dense<XprType, Rows, Cols, Order, false>
 ...
 public:
  ...
  /** Fixed-size constructor
   */
  EIGEN_DEVICE_FUNC inline constexpr ReshapedImpl_dense(XprType& xpr) : m_xpr(xpr), m_rows(Rows), m_cols(Cols) {}

  /** Dynamic-size constructor
   */
  EIGEN_DEVICE_FUNC inline constexpr ReshapedImpl_dense(XprType& xpr, Index nRows, Index nCols)
...
class ReshapedImpl_dense<XprType, Rows, Cols, Order, true> : public MapBase<Reshaped<XprType, Rows, Cols, Order> > {
 ...
 public:
  ...
  /** Fixed-size constructor
   */
  EIGEN_DEVICE_FUNC inline constexpr ReshapedImpl_dense(XprType& xpr) : Base(xpr.data()), m_xpr(xpr) {}
...
struct reshaped_evaluator<ArgType, Rows, Cols, Order, /* HasDirectAccess */ false>
  ...
  EIGEN_DEVICE_FUNC inline constexpr RowCol index_remap(Index rowId, Index colId) const {
    if (Order == ColMajor) {
