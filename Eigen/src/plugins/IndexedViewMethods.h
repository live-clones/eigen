...
IndexedView<Derived, const RowIndicesT (&)[RowIndicesN], IvcColType<ColIndices>> operator()(
  ...
  return IndexedView<Derived, const RowIndicesT(&)[RowIndicesN], IvcColType<ColIndices>>(derived(), rowIndices,
                                                                                         ivcCol(colIndices));
}
...
IndexedView<const Derived, const RowIndicesT (&)[RowIndicesN], IvcColType<ColIndices>> operator()(
  ...
  return IndexedView<const Derived, const RowIndicesT(&)[RowIndicesN], IvcColType<ColIndices>>(derived(), rowIndices,
                                                                                               ivcCol(colIndices));
}
...
IndexedView<Derived, IvcRowType<RowIndices>, const ColIndicesT (&)[ColIndicesN]> operator()(
  ...
  return IndexedView<Derived, IvcRowType<RowIndices>, const ColIndicesT(&)[ColIndicesN]>(derived(), ivcRow(rowIndices),
                                                                                         colIndices);
}
...
IndexedView<const Derived, IvcRowType<RowIndices>, const ColIndicesT (&)[ColIndicesN]> operator()(
  ...
  return IndexedView<const Derived, IvcRowType<RowIndices>, const ColIndicesT(&)[ColIndicesN]>(
