...
template<typename DstScalar,typename SrcScalar> struct assign_op {
  ...
  EIGEN_EMPTY_STRUCT_CTOR(assign_op) EIGEN_CONSTEXPR
...
template<typename DstScalar,typename SrcScalar> struct add_assign_op {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE EIGEN_CONSTEXPR void assignCoeff(DstScalar& a, const SrcScalar& b) const { a += b; }
...
template<typename Scalar> struct swap_assign_op {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE EIGEN_CONSTEXPR void assignCoeff(Scalar& a, const Scalar& b) const
  {
#ifdef EIGEN_GPUCC
