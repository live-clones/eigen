...
TEST(NoresizeTest, Basic) {
  noresize_assign_to_empty<MatrixXf>();
  noresize_assign_to_empty<MatrixXd>();
  noresize_assign_to_empty<MatrixXcf>();
  noresize_assign_to_empty<MatrixXcd>();
  noresize_assign_to_empty<ArrayXXd>();
  noresize_assign_to_empty<ArrayXXcd>();
  noresize_assign_to_empty<VectorXf>();
  noresize_assign_to_empty<RowVectorXd>();

  noresize_assign_expression_to_empty<MatrixXd>();
  noresize_assign_expression_to_empty<ArrayXXd>();

  noresize_construct_from_expression<MatrixXd>();
  noresize_construct_from_expression<ArrayXXd>();

  noresize_col_access<MatrixXd>();
  noresize_col_access<MatrixXf>();

  noresize_size_mismatch<MatrixXd>();
  noresize_size_mismatch<MatrixXf>();
  noresize_size_mismatch<VectorXd>();
}
