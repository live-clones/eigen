...
void IncompleteLUT<Scalar, StorageIndex>::analyzePattern(const MatrixType_& amat) {
  ...
  // NOTE: Current strategy uses mat2 + mat1 (union of patterns) for symmetrization.
  // For highly symmetric matrices, this preserves structure well. For non-symmetric patterns,
  // mat2 * mat1 (product) may give better ordering by connecting distant nodes. Consider
  // auto-detecting pattern symmetry and selecting the appropriate strategy.
