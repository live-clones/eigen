...
class TriangularBase : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator[](Index row, Index col) const { return operator()(row, col); }
  EIGEN_DEVICE_FUNC inline constexpr Scalar& operator[](Index row, Index col) { return operator()(row, col); }
#endif
...
class TriangularView
 ...
 public:
  ...
  template <typename Other>
  EIGEN_DEVICE_FUNC inline constexpr Solve<TriangularView, Other> solve(const MatrixBase<Other>& other) const {
