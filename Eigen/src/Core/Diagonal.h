...
EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR typename MatrixBase<Derived>::DiagonalReturnType
...
template<typename Derived>
EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR typename MatrixBase<Derived>::ConstDiagonalReturnType
