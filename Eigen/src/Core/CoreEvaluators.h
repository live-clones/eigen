...
struct ternary_select_helper {
  ...
  using TernaryOp = scalar_boolean_select_op<Scalar, Scalar, typename typed_cmp_helper<Scalar, Scalar, true>::type>;
...
struct evaluator<CwiseTernaryOp<scalar_boolean_select_op<Scalar, Scalar, bool>, Arg1, Arg2,
    ...
    : public ternary_select_helper<Arg1, Arg2, Scalar, CmpLhsType, CmpRhsType, cmp>::Base {
  using Helper = ternary_select_helper<Arg1, Arg2, Scalar, CmpLhsType, CmpRhsType, cmp>;
