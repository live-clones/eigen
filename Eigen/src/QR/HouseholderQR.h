        ...
        : public SolverBase<HouseholderQR<MatrixType_> >
{
  public:
    ...
    typedef Matrix<Scalar, RowsAtCompileTime, RowsAtCompileTime, internal::storage_order_flag(MatrixType::Flags), MaxRowsAtCompileTime, MaxRowsAtCompileTime> MatrixQType;
