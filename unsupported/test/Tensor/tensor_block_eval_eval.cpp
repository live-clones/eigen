...
TEST(TensorBlockEvalTest, Eval) {
  ...
  (test_eval_tensor_scan<float, 2, RowMajor>());
  (test_eval_tensor_scan<float, 3, RowMajor>());
  (test_eval_tensor_scan<float, 4, RowMajor>());
  (test_eval_tensor_scan<float, 2, ColMajor>());
  (test_eval_tensor_scan<float, 3, ColMajor>());
  (test_eval_tensor_scan<float, 4, ColMajor>());
  (test_eval_tensor_fft<float, 2, RowMajor>());
  (test_eval_tensor_fft<float, 3, RowMajor>());
  (test_eval_tensor_fft<float, 4, RowMajor>());
  (test_eval_tensor_fft<float, 2, ColMajor>());
  (test_eval_tensor_fft<float, 3, ColMajor>());
  (test_eval_tensor_fft<float, 4, ColMajor>());
  (test_eval_composed_block_ops<float, 2, RowMajor>());
  (test_eval_composed_block_ops<float, 3, RowMajor>());
  (test_eval_composed_block_ops<float, 4, RowMajor>());
  (test_eval_composed_block_ops<float, 2, ColMajor>());
  (test_eval_composed_block_ops<float, 3, ColMajor>());
  (test_eval_composed_block_ops<float, 4, ColMajor>());
  (test_eval_contract_pad_composition<float, RowMajor>());
  (test_eval_contract_pad_composition<float, ColMajor>());
  ...
  (test_eval_tensor_slice_bool_composite<1, RowMajor>());
  (test_eval_tensor_slice_bool_composite<2, RowMajor>());
  (test_eval_tensor_slice_bool_composite<3, RowMajor>());
  (test_eval_tensor_slice_bool_composite<1, ColMajor>());
  (test_eval_tensor_slice_bool_composite<2, ColMajor>());
  (test_eval_tensor_slice_bool_composite<3, ColMajor>());
