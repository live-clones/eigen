    ...
    for (int ct = 0; ct < cw; ct += 2 * svlw) {
      ...
      if (pw == 2 * svlw && cw == 2 * svlw) {
        ...
        for (; k < depth_4; k += 4) {
          ...
          svmopa_za32_f32_m(0, pg, pg, a0_lo, b0_lo);
          svmopa_za32_f32_m(1, pg, pg, a0_lo, b0_hi);
          svmopa_za32_f32_m(2, pg, pg, a0_hi, b0_lo);
          svmopa_za32_f32_m(3, pg, pg, a0_hi, b0_hi);
          ...
          svmopa_za32_f32_m(0, pg, pg, a1_lo, b1_lo);
          svmopa_za32_f32_m(1, pg, pg, a1_lo, b1_hi);
          svmopa_za32_f32_m(2, pg, pg, a1_hi, b1_lo);
          svmopa_za32_f32_m(3, pg, pg, a1_hi, b1_hi);
          ...
          svmopa_za32_f32_m(0, pg, pg, a2_lo, b2_lo);
          svmopa_za32_f32_m(1, pg, pg, a2_lo, b2_hi);
          svmopa_za32_f32_m(2, pg, pg, a2_hi, b2_lo);
          svmopa_za32_f32_m(3, pg, pg, a2_hi, b2_hi);
          ...
          svmopa_za32_f32_m(0, pg, pg, a3_lo, b3_lo);
          svmopa_za32_f32_m(1, pg, pg, a3_lo, b3_hi);
          svmopa_za32_f32_m(2, pg, pg, a3_hi, b3_lo);
          svmopa_za32_f32_m(3, pg, pg, a3_hi, b3_hi);
        }
        ...
        for (; k < depth; ++k) {
          ...
          svfloat32_t a_lo = svget2_f32(va, 0), a_hi = svget2_f32(va, 1);
          svfloat32_t b_lo = svget2_f32(vb, 0), b_hi = svget2_f32(vb, 1);
          svmopa_za32_f32_m(0, pg, pg, a_lo, b_lo);
          svmopa_za32_f32_m(1, pg, pg, a_lo, b_hi);
          svmopa_za32_f32_m(2, pg, pg, a_hi, b_lo);
          svmopa_za32_f32_m(3, pg, pg, a_hi, b_hi);
        }
      } else {
        for (Index k = 0; k < depth; ++k) {
