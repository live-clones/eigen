...
macro(ei_add_test_internal testname testname_with_suffix)
  ...
  if(EIGEN_ADD_TEST_FILENAME_EXTENSION STREQUAL cu)
    ...
    elseif(EIGEN_TEST_CUDA_NVC)
      ...
      add_executable(${targetname} ${filename})
      # nvc++ needs -cuda and -gpu flags on the link line for its CUDA runtime.
      set(CUDA_NVC_LINK_FLAGS "-cuda")
      foreach(GPU IN LISTS EIGEN_CUDA_COMPUTE_ARCH)
        list(APPEND CUDA_NVC_LINK_FLAGS "-gpu=cc${GPU}")
      endforeach()
      set(CUDA_NVC_LINK_LIBRARIES "cudart_static" "cuda" "dl" "pthread")
      if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
        list(APPEND CUDA_NVC_LINK_LIBRARIES "rt")
      endif()
      target_link_libraries(${targetname} ${CUDA_NVC_LINK_FLAGS} ${CUDA_NVC_LINK_LIBRARIES})
    else()
