...
EIGEN_DECLARE_TEST(stdvector) {
  ...
  check_stdvector_matrix(Matrix3d());
  ...
  // some dynamic sizes
  check_stdvector_matrix(MatrixXd(1, 1));
  check_stdvector_matrix(VectorXd(20));
  check_stdvector_matrix(RowVectorXf(20));
  check_stdvector_matrix(MatrixXcf(10, 10));

  // some Transform
  check_stdvector_transform(Projective2f());
  check_stdvector_transform(Projective3f());
  check_stdvector_transform(Projective3d());
  // heck_stdvector_transform(Projective4d());

  // some Quaternion
  check_stdvector_quaternion(Quaternionf());
  check_stdvector_quaternion(Quaterniond());
}
