...
class SelfAdjointEigenSolver {
 public:
  ...
  explicit SelfAdjointEigenSolver(const MatrixBase<InputType>& A, int options = ComputeEigenvectors) {
    compute(A, options);
  }
  ...
  template <typename InputType>
  SelfAdjointEigenSolver(Context& ctx, const MatrixBase<InputType>& A, int options = ComputeEigenvectors)
      : solver_ctx_(ctx) {
    compute(A, options);
  }
  ...
  template <typename InputType>
  SelfAdjointEigenSolver& compute(const MatrixBase<InputType>& A, int options = ComputeEigenvectors) {
