...
struct quat_product<Architecture::Target, Derived, OtherDerived, float> {
  ...
  static constexpr Quaternion<float> run(const QuaternionBase<Derived>& _a, const QuaternionBase<OtherDerived>& _b) {
...
struct quat_conj<Architecture::Target, Derived, float> {
  ...
  static constexpr Quaternion<float> run(const QuaternionBase<Derived>& q) {
...
struct cross3_impl<Architecture::Target, VectorLhs, VectorRhs, float, true> {
  ...
  static constexpr DstPlainType run(const VectorLhs& lhs, const VectorRhs& rhs) {
...
struct quat_product<Architecture::Target, Derived, OtherDerived, double> {
  ...
  static constexpr Quaternion<double> run(const QuaternionBase<Derived>& _a, const QuaternionBase<OtherDerived>& _b) {
...
struct quat_conj<Architecture::Target, Derived, double> {
  ...
  static constexpr Quaternion<double> run(const QuaternionBase<Derived>& q) {
    evaluator<typename Derived::Coefficients> qe(q.coeffs());
    Quaternion<double> res;
