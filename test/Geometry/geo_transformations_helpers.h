...
// Shared header for split geo_transformations tests.

#ifndef EIGEN_TEST_GEO_TRANSFORMATIONS_HELPERS_H
#define EIGEN_TEST_GEO_TRANSFORMATIONS_HELPERS_H
...
void transform_associativity(const RotationType& R) {
  ...
  transform_associativity2(A1c, A1, P1, A2, v2, h1);
  transform_associativity2(A1c, A1, P1, A2c, v2, h1);
  transform_associativity2(A1c, A1, P1, v1.asDiagonal(), v2, h1);
  transform_associativity2(A1c, A1, P1, ScalingType(v1), v2, h1);
  transform_associativity2(A1c, A1, P1, Scaling(v1), v2, h1);
  transform_associativity2(A1c, A1, P1, Scaling(s1), v2, h1);
  transform_associativity2(A1c, A1, P1, TranslationType(v1), v2, h1);
  transform_associativity_left(A1c, A1, P1, L, v2, h1);
  transform_associativity2(A1c, A1, P1, R, v2, h1);
...
#endif  // EIGEN_TEST_GEO_TRANSFORMATIONS_HELPERS_H
