...
struct blas_traits {
  ...
  EIGEN_DEVICE_FUNC static constexpr EIGEN_DEVICE_FUNC ExtractType extract(const XprType& x) { return x; }
  EIGEN_DEVICE_FUNC static constexpr EIGEN_DEVICE_FUNC const Scalar extractScalarFactor(const XprType&) {
    return Scalar(1);
  }
};
