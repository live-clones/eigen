...
TEST(QRColpivotingTest, RankDetectionStress) {
  qr_rank_detection_stress<MatrixXf>();
  qr_rank_detection_stress<MatrixXd>();
}

TEST(QRColpivotingTest, ThresholdEfficiency) {
  qr_threshold_efficiency<MatrixXf>();
  qr_threshold_efficiency<MatrixXd>();
}

TEST(QRColpivotingTest, RankGap) {
  qr_rank_gap_test<MatrixXf>();
  qr_rank_gap_test<MatrixXd>();
}
