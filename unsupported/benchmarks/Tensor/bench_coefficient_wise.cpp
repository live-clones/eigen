...
BENCHMARK(BM_Add_ThreadPool)->Apply(CwiseThreadPoolSizes);
BENCHMARK(BM_Mul_ThreadPool)->Apply(CwiseThreadPoolSizes);
BENCHMARK(BM_FMA_ThreadPool)->Apply(CwiseThreadPoolSizes);
BENCHMARK(BM_Exp_ThreadPool)->Apply(CwiseThreadPoolSizes);
BENCHMARK(BM_Tanh_ThreadPool)->Apply(CwiseThreadPoolSizes);
BENCHMARK(BM_ReLU_ThreadPool)->Apply(CwiseThreadPoolSizes);
