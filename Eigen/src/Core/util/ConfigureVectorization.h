 ...
 * internal::twoprod ignore this setting: they call numext::fma where it is a single instruction
 * (EIGEN_VECTORIZE_FMA, or FP_FAST_FMA for a scalar) and use Dekker's product elsewhere.
