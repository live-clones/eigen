...
struct static_val {
  ...
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr operator uint64_t() const { return n; }

  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr static_val() = default;
...
struct TensorUInt128 {
  ...
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr TensorUInt128(HIGH y, LOW x) : high(y), low(x) {}

  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr operator LOW() const { return low; }
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr LOW lower() const { return low; }
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr HIGH upper() const { return high; }
};

template <typename HL, typename LL, typename HR, typename LR>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr bool operator==(const TensorUInt128<HL, LL>& lhs,
...
template <typename HL, typename LL, typename HR, typename LR>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE constexpr TensorUInt128<uint64_t, uint64_t> operator+(
