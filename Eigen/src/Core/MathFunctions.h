...
inline uint32_t log2(uint32_t x) {
  EIGEN_ALIGN_MAX static constexpr uint8_t table[32] = {0, 9,  1,  10, 13, 21, 2,  29, 11, 14, 16, 18, 22, 25, 3, 30,
...
inline int log2(int x) { return log2(uint32_t(x)); }
inline int64_t log2(int64_t x) { return log2(uint64_t(x)); }
