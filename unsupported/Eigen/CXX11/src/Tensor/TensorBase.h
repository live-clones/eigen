...
class TensorBase<Derived, ReadOnlyAccessors>
{
  public:
    ...
    constexpr const TensorCwiseUnaryOp<internal::bind1st_op<internal::scalar_sum_op<Scalar> >, const Derived>
    ...
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE friend
    constexpr const TensorCwiseUnaryOp<internal::bind1st_op<internal::scalar_difference_op<Scalar> >, const Derived>
    operator- (Scalar lhs, const Derived& rhs) {
    ...
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE friend
    constexpr const TensorCwiseUnaryOp<internal::bind1st_op<internal::scalar_product_op<Scalar> >, const Derived>
    operator* (Scalar lhs, const Derived& rhs) {
    ...
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE friend
    constexpr const TensorCwiseUnaryOp<internal::bind1st_op<internal::scalar_quotient_op<Scalar> >, const Derived>
    operator/ (Scalar lhs, const Derived& rhs) {
    ...
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE constexpr const std::conditional_t<internal::is_same<NewType, CoeffReturnType>::value,
                                                      Derived,
    ...
    template <typename Dims> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    constexpr const TensorReductionOp<internal::AndReducer, const Dims, const std::conditional_t<internal::is_same<bool, CoeffReturnType>::value, Derived, TensorConversionOp<bool, const Derived> > >
    all(const Dims& dims) const {
      return cast<bool>().reduce(dims, internal::AndReducer());
    }

    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    constexpr const TensorReductionOp<internal::AndReducer, const DimensionList<Index, NumDimensions>, const std::conditional_t<internal::is_same<bool, CoeffReturnType>::value, Derived, TensorConversionOp<bool, const Derived> > >
    all() const {
      DimensionList<Index, NumDimensions> in_dims;
    ...
    template <typename Dims> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    constexpr const TensorReductionOp<internal::OrReducer, const Dims, const std::conditional_t<internal::is_same<bool, CoeffReturnType>::value, Derived, TensorConversionOp<bool, const Derived> > >
    any(const Dims& dims) const {
      return cast<bool>().reduce(dims, internal::OrReducer());
    }

    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    constexpr const TensorReductionOp<internal::OrReducer, const DimensionList<Index, NumDimensions>, const std::conditional_t<internal::is_same<bool, CoeffReturnType>::value, Derived, TensorConversionOp<bool, const Derived> > >
    any() const {
      DimensionList<Index, NumDimensions> in_dims;
   ...
   EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    ...
    inline constexpr const TensorWithFormat<Derived,DerivedTraits::Layout,DerivedTraits::NumDimensions, Format> format(const Format& fmt) const {
