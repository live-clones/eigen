...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr typename internal::cross_impl<Derived, OtherDerived>::return_type
...
struct cross3_impl {
  EIGEN_DEVICE_FUNC static constexpr typename internal::plain_matrix_type<VectorLhs>::type run(const VectorLhs& lhs,
                                                                                               const VectorRhs& rhs) {
...
template <typename Derived>
template <typename OtherDerived>
EIGEN_DEVICE_FUNC constexpr typename MatrixBase<Derived>::PlainObject MatrixBase<Derived>::cross3(
...
struct unitOrthogonal_selector {
  ...
  EIGEN_DEVICE_FUNC static constexpr VectorType run(const Derived& src) {
