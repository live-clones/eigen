...
void jacobisvd_no_spurious_overflow_regression() {
  Matrix3f m;
...
#if defined(FE_ALL_EXCEPT) && defined(FE_OVERFLOW)
  ...
  VERIFY((std::fetestexcept(FE_OVERFLOW) == 0));
#endif
...
EIGEN_DECLARE_TEST(jacobisvd) {
  ...
  CALL_SUBTEST_4((jacobisvd_no_spurious_overflow_regression()));
