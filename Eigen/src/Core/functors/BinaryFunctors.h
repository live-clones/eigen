...
struct scalar_hypot_op<Scalar, Scalar> : binary_op_base<Scalar, Scalar> {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& x, const Scalar& y) const {
...
struct bind1st_op : BinaryOp {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr result_type operator()(const second_argument_type& b) const {
    return BinaryOp::operator()(m_value, b);
  }

  template <typename Packet>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Packet packetOp(const Packet& b) const {
...
struct bind2nd_op : BinaryOp {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr result_type operator()(const first_argument_type& a) const {
