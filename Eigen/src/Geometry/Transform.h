...
class Transform {
 ...
 public:
  ...
  template <int OtherMode, int OtherOptions>
  constexpr typename icc_11_workaround<OtherMode, OtherOptions>::ResultType operator*(
...
struct projective_transform_inverse {
  EIGEN_DEVICE_FUNC static constexpr void run(const TransformType&, TransformType&) {}
};
