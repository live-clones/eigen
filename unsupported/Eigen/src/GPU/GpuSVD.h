...
class SVD {
 public:
  ...
  explicit SVD(const MatrixBase<InputType>& A, unsigned int options = ComputeThinU | ComputeThinV) {
    compute(A, options);
  }
  ...
  template <typename InputType>
  SVD(Context& ctx, const MatrixBase<InputType>& A, unsigned int options = ComputeThinU | ComputeThinV)
      : solver_ctx_(ctx) {
    compute(A, options);
  }
  ...
  template <typename InputType>
  SVD& compute(const MatrixBase<InputType>& A, unsigned int options = ComputeThinU | ComputeThinV) {
