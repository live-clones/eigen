...
class TensorFixedSize : public TensorBase<TensorFixedSize<Scalar_, Dimensions_, Options_, IndexType> > {
 ...
 public:
  ...
  constexpr EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Index dimension(std::size_t n) const {
  ...
  constexpr EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar* data() { return m_storage.data(); }
  constexpr EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Scalar* data() const { return m_storage.data(); }
 ...
 protected:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Index linearizedIndex(const array<Index, NumIndices>& indices) const {
    EIGEN_IF_CONSTEXPR (Options & RowMajor) {
      return internal::convert_index<Index>(m_storage.dimensions().IndexOfRowMajor(indices));
    } else {
      return internal::convert_index<Index>(m_storage.dimensions().IndexOfColMajor(indices));
    }
  }
};
