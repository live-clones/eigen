...
// Shared header for split simplicial_cholesky tests.

#ifndef EIGEN_TEST_SIMPLICIAL_CHOLESKY_HELPERS_H
#define EIGEN_TEST_SIMPLICIAL_CHOLESKY_HELPERS_H
...
#endif  // EIGEN_TEST_SIMPLICIAL_CHOLESKY_HELPERS_H
