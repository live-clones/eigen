...
public:
  ...
  EIGEN_STRONG_INLINE void assignPartialPacket(Index row, Index col, Index n, Index offset)
  {
    ...
    const_cast<SrcEvaluatorTypeT&>(m_src).template writePartialPacket<LoadMode>(row, col, m_dst.template partialPacket<StoreMode,PacketType>(row, col, n, offset), n, offset);
  ...
  EIGEN_STRONG_INLINE void assignPartialPacket(Index index, Index n, Index offset)
  {
    ...
    const_cast<SrcEvaluatorTypeT&>(m_src).template writePartialPacket<LoadMode>(index, m_dst.template partialPacket<StoreMode,PacketType>(index, n, offset), n, offset);
