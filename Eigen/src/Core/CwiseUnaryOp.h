...
class CwiseUnaryOp : public CwiseUnaryOpImpl<UnaryOp, XprType, typename internal::traits<XprType>::StorageKind>,
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr explicit CwiseUnaryOp(const XprType& xpr,
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr const UnaryOp& functor() const { return m_functor; }
  ...
  /** \returns the nested expression */
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr internal::remove_all_t<XprTypeNested>& nestedExpression() {
    return m_xpr;
  }
