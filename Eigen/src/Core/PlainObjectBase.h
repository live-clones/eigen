...
class PlainObjectBase : public internal::dense_xpr_base<Derived>::type {
 ...
 protected:
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr PlainObjectBase(const DenseBase<OtherDerived>& other) {
    resizeLike(other);
    _set_noalias(other);
  }
  ...
  /** \sa PlainObjectBase::operator=(const EigenBase<OtherDerived>&) */
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr PlainObjectBase(const EigenBase<OtherDerived>& other) {
    resizeLike(other);
    *this = other.derived();
  }
