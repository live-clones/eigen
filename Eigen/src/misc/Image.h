...
struct traits<image_retval_base<DecompositionType> > {
  ...
  using ReturnType = Matrix<typename MatrixType::Scalar, MatrixType::RowsAtCompileTime, Dynamic,
                            plain_object_options<MatrixType>::value, MatrixType::MaxRowsAtCompileTime,
...
struct image_retval_base : public ReturnByValue<image_retval_base<DecompositionType_> > {
  ...
  constexpr Index rank() const { return m_rank; }
  constexpr const DecompositionType& dec() const { return m_dec; }
  constexpr const MatrixType& originalMatrix() const { return m_originalMatrix; }
