 ...
 * This is load-bearing but only an implicit invariant: it relies on no other
 * float consumer instantiating the packer with mr == kSmeMr (holds today --
 * generic float traits give mr <= 12 -- but is not enforced at compile time).
 *****************************************************************************/
