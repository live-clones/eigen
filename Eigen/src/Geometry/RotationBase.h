...
class RotationBase {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr RotationMatrixType toRotationMatrix() const { return derived().toRotationMatrix(); }

  /** \returns an equivalent rotation matrix
   * This function is added to conform with the Transform class' naming scheme.
   */
  EIGEN_DEVICE_FUNC constexpr RotationMatrixType matrix() const { return derived().toRotationMatrix(); }

  /** \returns the inverse rotation */
  EIGEN_DEVICE_FUNC constexpr Derived inverse() const { return derived().inverse(); }

  /** \returns the concatenation of the rotation \c *this with a translation \a t */
  EIGEN_DEVICE_FUNC constexpr Transform<Scalar, Dim, Isometry> operator*(const Translation<Scalar, Dim>& t) const {
    return Transform<Scalar, Dim, Isometry>(*this) * t;
  }

  /** \returns the concatenation of the rotation \c *this with a uniform scaling \a s */
  EIGEN_DEVICE_FUNC constexpr RotationMatrixType operator*(const UniformScaling<Scalar>& s) const {
  ...
  template <typename OtherDerived>
  friend EIGEN_DEVICE_FUNC constexpr RotationMatrixType operator*(const EigenBase<OtherDerived>& l, const Derived& r) {
    return l.derived() * r.toRotationMatrix();
  }

  /** \returns the concatenation of a scaling \a l with the rotation \a r */
  EIGEN_DEVICE_FUNC friend constexpr Transform<Scalar, Dim, Affine> operator*(const DiagonalMatrix<Scalar, Dim>& l,
                                                                              const Derived& r) {
  ...
  EIGEN_DEVICE_FUNC constexpr VectorType _transformVector(const OtherVectorType& v) const {
...
struct rotation_base_generic_product_selector<RotationDerived, MatrixType, false> {
  ...
  EIGEN_DEVICE_FUNC static constexpr ReturnType run(const RotationDerived& r, const MatrixType& m) {
...
struct rotation_base_generic_product_selector<RotationDerived, DiagonalMatrix<Scalar, Dim, MaxDim>, false> {
  ...
  EIGEN_DEVICE_FUNC static constexpr ReturnType run(const RotationDerived& r,
 ...
 */
template <typename Scalar, int Dim, typename OtherScalar, std::enable_if_t<std::is_scalar<OtherScalar>::value, int> = 0>
EIGEN_DEVICE_FUNC static constexpr Matrix<Scalar, 2, 2> toRotationMatrix(const OtherScalar& s) {
...
EIGEN_DEVICE_FUNC static constexpr typename OtherDerived::RotationMatrixType toRotationMatrix(
...
template <typename Scalar, int Dim, typename OtherDerived,
          std::enable_if_t<!std::is_same<Scalar, typename OtherDerived::Scalar>::value, int> = 0>
EIGEN_DEVICE_FUNC static constexpr Matrix<Scalar, Dim, Dim> toRotationMatrix(const RotationBase<OtherDerived, Dim>& r) {
  return r.toRotationMatrix().template cast<Scalar>();
}

template <typename Scalar, int Dim, typename OtherDerived,
          std::enable_if_t<std::is_same<Scalar, typename OtherDerived::Scalar>::value, int> = 0>
EIGEN_DEVICE_FUNC static constexpr const OtherDerived& toRotationMatrix(const MatrixBase<OtherDerived>& mat) {
...
template <typename Scalar, int Dim, typename OtherDerived,
          std::enable_if_t<!std::is_same<Scalar, typename OtherDerived::Scalar>::value, int> = 0>
EIGEN_DEVICE_FUNC static constexpr auto toRotationMatrix(const MatrixBase<OtherDerived>& mat) {
  EIGEN_STATIC_ASSERT(OtherDerived::RowsAtCompileTime == Dim && OtherDerived::ColsAtCompileTime == Dim,
                      YOU_MADE_A_PROGRAMMING_MISTAKE)
