...
class VectorBlock : public Block<VectorType, internal::traits<VectorType>::Flags & RowMajorBit ? 1 : Size,
 ...
 public:
   ...
   */
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr VectorBlock(VectorType& vector, Index start, Index size)
      : Base(vector, IsColVector ? start : 0, IsColVector ? 0 : start, IsColVector ? size : 1, IsColVector ? 1 : size) {
  }

  /** Fixed-size constructor
   */
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr VectorBlock(VectorType& vector, Index start)
