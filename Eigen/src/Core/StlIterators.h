...
class pointer_based_stl_iterator {
 ...
 public:
  ...
  constexpr bool operator!=(const pointer_based_stl_iterator& other) const { return m_ptr != other.m_ptr; }
  constexpr bool operator<(const pointer_based_stl_iterator& other) const {
  ...
  constexpr bool operator<=(const pointer_based_stl_iterator& other) const { return !(other < *this); }
  constexpr bool operator>(const pointer_based_stl_iterator& other) const { return other < *this; }
  constexpr bool operator>=(const pointer_based_stl_iterator& other) const { return !(*this < other); }
  ...
  constexpr bool operator<=(const other_iterator& other) const { return !(other < *this); }
  constexpr bool operator>(const other_iterator& other) const { return other < *this; }
  constexpr bool operator>=(const other_iterator& other) const { return !(*this < other); }
...
class subvector_stl_iterator : public indexed_based_stl_iterator_base<subvector_stl_iterator<XprType, Direction>> {
 ...
 public:
  ...
  constexpr subvector_stl_iterator(const typename Base::non_const_iterator& other) : Base(other) {}
...
class subvector_stl_reverse_iterator
 ...
 public:
  ...
  constexpr subvector_stl_reverse_iterator(const typename Base::non_const_iterator& other) : Base(other) {}
