...
class FullPivLU : public SolverBase<FullPivLU<MatrixType_, PermutationIndex_> > {
 public:
   ...
   * \sa permutationQ()
   */
  EIGEN_DEVICE_FUNC inline constexpr const PermutationPType& permutationP() const {
    eigen_assert(m_isInitialized && "LU is not initialized.");
    return m_p;
  }
   ...
   * \sa permutationP()
   */
  inline constexpr const PermutationQType& permutationQ() const {
    eigen_assert(m_isInitialized && "LU is not initialized.");
    return m_q;
  }
   ...
   * \sa image()
   */
  inline constexpr const internal::kernel_retval<FullPivLU> kernel() const {
    eigen_assert(m_isInitialized && "LU is not initialized.");
   ...
   * \sa kernel()
   */
  inline constexpr const internal::image_retval<FullPivLU> image(const MatrixType& originalMatrix) const {
    eigen_assert(m_isInitialized && "LU is not initialized.");
  ...
  inline constexpr Solve<FullPivLU, Rhs> solve(const MatrixBase<Rhs>& b) const;
#endif
   ...
   */
  inline constexpr Inverse<FullPivLU> inverse() const {
    eigen_assert(m_isInitialized && "LU is not initialized.");
...
inline constexpr FullPivLU<typename MatrixBase<Derived>::PlainObject, PermutationIndex> MatrixBase<Derived>::fullPivLu()
    const {
