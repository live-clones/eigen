...
/////////// QR module ///////////
    ...
    template<typename StorageIndex = int> inline const ColPivHouseholderQR<PlainObject, StorageIndex> colPivHouseholderQr() const;
    template<typename StorageIndex = int> inline const FullPivHouseholderQR<PlainObject, StorageIndex> fullPivHouseholderQr() const;
    template<typename StorageIndex = int> inline const CompleteOrthogonalDecomposition<PlainObject, StorageIndex> completeOrthogonalDecomposition() const;
