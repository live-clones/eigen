#ifndef EIGEN_TEST_PRODUCT_SMALL_HELPERS_H
#define EIGEN_TEST_PRODUCT_SMALL_HELPERS_H
...
inline const TC &ref_prod(TC &C, const TA &A, const TB &B) {
...
template <int>
inline void product_small_regressions() {
  {
...
template <typename T>
inline void product_sweep(int max_m, int max_k, int max_n) {
...
#endif  // EIGEN_TEST_PRODUCT_SMALL_HELPERS_H
