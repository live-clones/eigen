...
// Shared header for split sparse_basic tests.
// IMPORTANT: This header defines Eigen plugin macros that must be
// included before any other Eigen header.

#ifndef EIGEN_TEST_SPARSE_BASIC_HELPERS_H
#define EIGEN_TEST_SPARSE_BASIC_HELPERS_H
...
#endif  // EIGEN_TEST_SPARSE_BASIC_HELPERS_H
