...
class LDLT : public SolverBase<LDLT<MatrixType_, UpLo_> > {
 public:
  ...
  inline constexpr Solve<LDLT, Rhs> solve(const MatrixBase<Rhs>& b) const;
#endif
...
inline constexpr LDLT<typename SelfAdjointView<MatrixType, UpLo>::PlainObject, UpLo>
 ...
 */
template <typename Derived>
inline constexpr LDLT<typename MatrixBase<Derived>::PlainObject> MatrixBase<Derived>::ldlt() const {
