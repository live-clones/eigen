...
struct evaluator_base
{
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE EIGEN_CONSTEXPR evaluator_base() {}
#if EIGEN_COMP_NVCC
                      ...
                      typename Block<ArgType, BlockRows, BlockCols, InnerPanel>::PlainObject>
{
    ...
    : mapbase_evaluator<XprType, typename XprType::PlainObject>(block)
  {
    ...
    eigen_assert((internal::is_constant_evaluated()
      || ((internal::UIntPtr(block.data()) % plain_enum_max(1,evaluator<XprType>::Alignment)) == 0)) && "data is not aligned");
  }
};
