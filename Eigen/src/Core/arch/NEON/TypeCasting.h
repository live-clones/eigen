...
#else
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2l)) int64_t lvals[4];
  pstore(lvals, a);
  pstore(lvals + 2, b);
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet4f))
...
#else
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2l)) int64_t lvals[2];
  pstore(lvals, a);
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2f))
...
#else
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2ul)) uint64_t uvals[4];
  pstore(uvals, a);
  pstore(uvals + 2, b);
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet4f))
...
#else
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2ul)) uint64_t uvals[2];
  pstore(uvals, a);
  EIGEN_ALIGN_TO_BOUNDARY(sizeof(Packet2f))
