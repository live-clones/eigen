...
#ifndef EIGEN_TEST_SPARSE_PRODUCT_H
#define EIGEN_TEST_SPARSE_PRODUCT_H
...
inline void test_mixed_storage() {
...
inline void test_sparse_vector_dense_product() {
...
#endif  // EIGEN_TEST_SPARSE_PRODUCT_H
