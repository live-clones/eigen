...
// Shared header for split product_trsolve tests.

#ifndef EIGEN_TEST_PRODUCT_TRSOLVE_HELPERS_H
#define EIGEN_TEST_PRODUCT_TRSOLVE_HELPERS_H
...
#endif  // EIGEN_TEST_PRODUCT_TRSOLVE_HELPERS_H
