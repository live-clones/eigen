...
struct scalar_opposite_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& a) const { return numext::negate(a); }
...
struct abs_knowing_score {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr result_type operator()(const Scalar& a, const Score&) const {
    return numext::abs(a);
  }
};
template <typename Scalar>
struct abs_knowing_score<Scalar, typename scalar_score_coeff_op<Scalar>::Score_is_abs> {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr result_type operator()(const Scal&, const result_type& a) const {
    return a;
  }
};
...
struct scalar_conjugate_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& a) const { return numext::conj(a); }
} template <typename Packet>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_cast_op {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr NewType operator()(const Scalar& a) const {
...
struct scalar_real_ref_op {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr result_type& operator()(Scalar& a) const {
    return numext::real_ref(a);
  }
};
template <typename Scalar>
...
struct scalar_exp_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return internal::pexp(a); }
  template <typename Packet>
...
struct scalar_expm1_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::expm1(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_log_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::log(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_log1p_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::log1p(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_log10_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const {
...
struct scalar_sqrt_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::sqrt(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_cbrt_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::cbrt(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline Packet packetOp(const Packet& a) const {
...
struct scalar_rsqrt_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::rsqrt(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_sin_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::sin(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_tan_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::tan(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_acos_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::acos(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_asin_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::asin(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_atan_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::atan(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_tanh_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::tanh(a); }
  template <typename Packet>
...
struct scalar_atanh_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::atanh(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& x) const {
    return patanh(x);
  }
...
struct scalar_sinh_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::sinh(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_asinh_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::asinh(a); }
};
...
struct scalar_cosh_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::cosh(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_acosh_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::acosh(a); }
};
...
struct scalar_round_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& a) const { return numext::round(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_floor_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& a) const { return numext::floor(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_rint_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& a) const { return numext::rint(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_ceil_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& a) const { return numext::ceil(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_trunc_op {
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Scalar operator()(const Scalar& a) const { return numext::trunc(a); }
  template <typename Packet>
  EIGEN_DEVICE_FUNC inline constexpr Packet packetOp(const Packet& a) const {
...
struct scalar_sign_op {
  EIGEN_DEVICE_FUNC inline constexpr Scalar operator()(const Scalar& a) const { return numext::sign(a); }
