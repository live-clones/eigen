...
TEST(IncompleteLUTTest, Basic) {
  ...
  test_zero_diagonal_2626<double>();
  test_zero_diagonal_2626<float>();
  test_structurally_singular<double>();
  test_zero_pivot_numerical_issue<double>();
  test_pattern_value_separation<double>();
}
