...
struct XprHelper {
  ...
  constexpr const PlainObjectType& xpr() const { return m_xpr; }
...
struct PermHelper {
  ...
  constexpr const type& perm() const { return m_perm; }
...
struct permutation_matrix_product<ExpressionType, Side, Transposed, SparseShape> {
  ...
  static constexpr void permute_outer(Dest& dst, const PermutationType& perm, const ExpressionType& xpr) {
  ...
  template <typename Dest, typename PermutationType>
  static constexpr void permute_inner(Dest& dst, const PermutationType& perm, const ExpressionType& xpr) {
  ...
  static constexpr void run(Dest& dst, const PermutationType& perm, const ExpressionType& xpr) {
...
constexpr const Product<SparseDerived, PermDerived, AliasFreeProduct> operator*(
 ...
 */
template <typename SparseDerived, typename PermDerived>
constexpr const Product<PermDerived, SparseDerived, AliasFreeProduct> operator*(
...
constexpr const Product<SparseDerived, Inverse<PermutationType>, AliasFreeProduct> operator*(
 ...
 */
template <typename SparseDerived, typename PermutationType>
constexpr const Product<Inverse<PermutationType>, SparseDerived, AliasFreeProduct> operator*(
