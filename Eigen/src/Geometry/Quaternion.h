...
class QuaternionBase : public RotationBase<Derived, 3>
{
 ...
 // typedef typename Matrix<Scalar,4,1> Coefficients;
  ...
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR CoeffReturnType x() const { return this->derived().coeffs().coeff(0); }
  /** \returns the \c y coefficient */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR CoeffReturnType y() const { return this->derived().coeffs().coeff(1); }
  /** \returns the \c z coefficient */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR CoeffReturnType z() const { return this->derived().coeffs().coeff(2); }
  /** \returns the \c w coefficient */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR CoeffReturnType w() const { return this->derived().coeffs().coeff(3); }

  /** \returns a reference to the \c x coefficient (if Derived is a non-const lvalue) */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR NonConstCoeffReturnType x() { return this->derived().coeffs().x(); }
  /** \returns a reference to the \c y coefficient (if Derived is a non-const lvalue) */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR NonConstCoeffReturnType y() { return this->derived().coeffs().y(); }
  /** \returns a reference to the \c z coefficient (if Derived is a non-const lvalue) */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR NonConstCoeffReturnType z() { return this->derived().coeffs().z(); }
  /** \returns a reference to the \c w coefficient (if Derived is a non-const lvalue) */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR NonConstCoeffReturnType w() { return this->derived().coeffs().w(); }

  /** \returns a read-only vector expression of the imaginary part (x,y,z) */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR const VectorBlock<const Coefficients,3> vec() const { return coeffs().template head<3>(); }

  /** \returns a vector expression of the imaginary part (x,y,z) */
  EIGEN_DEVICE_FUNC inline VectorBlock<Coefficients,3> vec() { return coeffs().template head<3>(); }

  /** \returns a read-only vector expression of the coefficients (x,y,z,w) */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR const typename internal::traits<Derived>::Coefficients& coeffs() const { return derived().coeffs(); }

  /** \returns a vector expression of the coefficients (x,y,z,w) */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR typename internal::traits<Derived>::Coefficients& coeffs() { return derived().coeffs(); }
...
//  { return operator=<Derived>(other); }
  ...
  /** \returns a quaternion representing an identity rotation
    ...
    */
  EIGEN_DEVICE_FUNC static EIGEN_CONSTEXPR Quaternion<Scalar> Identity() { return Quaternion<Scalar>(Scalar(1), Scalar(0), Scalar(0), Scalar(0)); }
  ...
  /** \returns the squared norm of the quaternion's coefficients
    ...
    */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Scalar squaredNorm() const { return coeffs().squaredNorm(); }
  ...
  EIGEN_DEVICE_FUNC inline Quaternion<Scalar> normalized() const { return Quaternion<Scalar>(coeffs().normalized()); }
    ...
    * \sa angularDistance()
    */
  template<class OtherDerived> EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Scalar dot(const QuaternionBase<OtherDerived>& other) const { return coeffs().dot(other.coeffs()); }

  template<class OtherDerived> EIGEN_DEVICE_FUNC Scalar angularDistance(const QuaternionBase<OtherDerived>& other) const;

  /** \returns an equivalent 3x3 rotation matrix */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Matrix3 toRotationMatrix() const;
  ...
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR bool operator==(const QuaternionBase<OtherDerived>& other) const
...
public:
  ...
  /** Constructs and initializes the quaternion \f$ w+xi+yj+zk \f$ from
    ...
    * [\c x, \c y, \c z, \c w]
    */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Quaternion(const Scalar& w, const Scalar& x, const Scalar& y, const Scalar& z) : m_coeffs(x, y, z, w){}

  /** Constructs and initialize a quaternion from the array data */
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR explicit Quaternion(const Scalar* data) : m_coeffs(data) {}
  ...
  EIGEN_DEVICE_FUNC explicit EIGEN_CONSTEXPR Quaternion(const MatrixBase<Derived>& other) { *this = other; }
  ...
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Coefficients& coeffs() { return m_coeffs;}
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR const Coefficients& coeffs() const { return m_coeffs;}
...
EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Derived& QuaternionBase<Derived>::operator=(const MatrixBase<MatrixDerived>& xpr)
{
...
/** Convert the quaternion to a 3x3 rotation matrix. The quaternion is required to
  ...
  */
template<class Derived>
EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR typename QuaternionBase<Derived>::Matrix3
...
/** \returns the multiplicative inverse of \c *this
  ...
  */
template <class Derived>
EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR Quaternion<typename internal::traits<Derived>::Scalar> QuaternionBase<Derived>::inverse() const
{
...
{
  typedef typename Other::Scalar Scalar;
  template<class Derived> EIGEN_DEVICE_FUNC static EIGEN_CONSTEXPR void run(QuaternionBase<Derived>& q, const Other& vec)
  {
    q.coeffs() = vec;
  }
};
