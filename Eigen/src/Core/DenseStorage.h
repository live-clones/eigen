...
struct plain_array
{
  ...
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR20
  plain_array()
  {
  ...
  #define EIGEN_MAKE_UNALIGNED_ARRAY_ASSERT(sizemask) \
    eigen_assert((internal::is_constant_evaluated() || ((internal::UIntPtr(eigen_unaligned_array_assert_workaround_gcc47(array)) & (sizemask)) == 0)) \
...
{
  T array[1];
  EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR plain_array() {}
...
#else
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR20 DenseStorage(const DenseStorage&) = default;
#endif
