...
/////////// QR module ///////////
    ...
    template<typename StorageIndex> inline const ColPivHouseholderQR<PlainObject, StorageIndex> colPivHouseholderQr() const;
    template<typename StorageIndex> inline const FullPivHouseholderQR<PlainObject, StorageIndex> fullPivHouseholderQr() const;
    template<typename StorageIndex> inline const CompleteOrthogonalDecomposition<PlainObject, StorageIndex> completeOrthogonalDecomposition() const;
