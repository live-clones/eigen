...
class PartialPivLU : public SolverBase<PartialPivLU<MatrixType_, PermutationIndex_> > {
 public:
   ...
   * \sa matrixL(), matrixU()
   */
  inline constexpr const MatrixType& matrixLU() const {
    eigen_assert(m_isInitialized && "PartialPivLU is not initialized.");
    return m_lu;
  }
   ...
   */
  inline constexpr const PermutationType& permutationP() const {
    eigen_assert(m_isInitialized && "PartialPivLU is not initialized.");
    return m_p;
  }
  ...
  inline constexpr Solve<PartialPivLU, Rhs> solve(const MatrixBase<Rhs>& b) const;
#endif

  /** \returns an estimate of the reciprocal condition number of the matrix of which \c *this is
      the LU decomposition.
    */
  inline constexpr RealScalar rcond() const {
    eigen_assert(m_isInitialized && "PartialPivLU is not initialized.");
   ...
   */
  inline constexpr Inverse<PartialPivLU> inverse() const {
    eigen_assert(m_isInitialized && "PartialPivLU is not initialized.");
...
inline constexpr PartialPivLU<typename MatrixBase<Derived>::PlainObject, PermutationIndex>
...
template <typename Derived>
template <typename PermutationIndex>
inline constexpr PartialPivLU<typename MatrixBase<Derived>::PlainObject, PermutationIndex> MatrixBase<Derived>::lu()
    const {
  return PartialPivLU<PlainObject, PermutationIndex>(eval());
}
