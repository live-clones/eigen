...
struct NoOpOutputKernel {
  ...
  EIGEN_ALWAYS_INLINE void operator()(
      [[maybe_unused]] const internal::blas_data_mapper<Scalar, Index, ColMajor>& output_mapper,
      [[maybe_unused]] const TensorContractionParams& params, [[maybe_unused]] Index i, [[maybe_unused]] Index j,
      [[maybe_unused]] Index num_rows, [[maybe_unused]] Index num_cols) const {}
};
