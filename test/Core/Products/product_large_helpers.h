...
// Shared header for split product_large tests.

#ifndef EIGEN_TEST_PRODUCT_LARGE_HELPERS_H
#define EIGEN_TEST_PRODUCT_LARGE_HELPERS_H
...
#endif  // EIGEN_TEST_PRODUCT_LARGE_HELPERS_H
