...
#endif  // not EIGEN_PARSED_BY_DOXYGEN
{
 public:
  ...
  EIGEN_DEVICE_FUNC constexpr bool hasNaN() const;
  EIGEN_DEVICE_FUNC constexpr bool allFinite() const;
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE constexpr Derived& operator*=(const RealScalar& other);
   ...
   */
  inline constexpr const WithFormat<Derived> format(const IOFormat& fmt) const {
