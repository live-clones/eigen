...
#define EIGEN_CPLUSPLUS 201703L
...
#if EIGEN_MAX_CPP_VER < 17 || EIGEN_COMP_CXXVER < 17 || (EIGEN_COMP_MSVC_STRICT && EIGEN_COMP_MSVC < 1914) ||      \
    (EIGEN_COMP_NVCC && EIGEN_COMP_NVCC < 110000) || (EIGEN_COMP_CLANG_STRICT && EIGEN_COMP_CLANG < 500) || \
