...
// Shared header for split eigensolver_selfadjoint tests.

#ifndef EIGEN_TEST_EIGENSOLVER_SELFADJOINT_HELPERS_H
#define EIGEN_TEST_EIGENSOLVER_SELFADJOINT_HELPERS_H
...
#endif  // EIGEN_TEST_EIGENSOLVER_SELFADJOINT_HELPERS_H
