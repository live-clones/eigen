...
EIGEN_DECLARE_TEST(serializer) {
  ...
  for (int i = 0; i < g_repeat; i++) {
    ...
    test_eigen_type(Eigen::Vector3f());
    test_eigen_type(Eigen::Matrix4d());
    test_eigen_type(Eigen::MatrixXd(15, 17));
    test_eigen_type(Eigen::SparseMatrix<float>(13, 12));
    test_eigen_type(Eigen::SparseVector<float>(17));

    test_dense_types(Eigen::Array33f(), Eigen::ArrayXd(10), Eigen::MatrixXd(15, 17));
  }
}
